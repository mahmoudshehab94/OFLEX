...
export function NotificationSettings({ userAccountId, role, driverId }: NotificationSettingsProps) {
  ...
  return (
    <div className="backdrop-blur-xl bg-slate-800/50 rounded-2xl shadow-lg border border-white/10 p-4 sm:p-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div className="flex items-start sm:items-center gap-3">
          <Bell className="h-6 w-6 text-blue-400 flex-shrink-0 mt-0.5 sm:mt-0" />
        ...
        {isOneSignalEnabled && (
          <button
            ...
            disabled={isLoading}
            className={`flex items-center justify-center gap-2 px-4 py-2 rounded-lg font-semibold transition-all whitespace-nowrap flex-shrink-0 w-full sm:w-auto ${
              isSubscribed
      ...
      {!isOneSignalEnabled && (
        <div className="p-3 sm:p-4 bg-amber-500/10 rounded-xl border border-amber-500/30 mb-4">
          <div className="flex items-start gap-2 sm:gap-3">
            <AlertCircle className="h-5 w-5 text-amber-400 flex-shrink-0 mt-0.5" />
            <div className="text-xs sm:text-sm text-amber-300 flex-1 min-w-0">
              <p className="font-semibold mb-1">Benachrichtigungen auf localhost deaktiviert</p>
      ...
      {message && (
        <div
          className={`flex items-start gap-2 sm:gap-3 p-3 sm:p-4 rounded-xl mb-4 border ${
      ...
      {isSubscribed && (
        <>
          <div className="mb-4 p-3 sm:p-4 bg-blue-500/10 rounded-xl border border-blue-500/30">
          ...
          <button
            ...
            className="flex items-center gap-2 text-xs sm:text-sm text-slate-300 hover:text-white transition-colors mb-4 w-full sm:w-auto font-medium"
          >
          ...
          {showAdvanced && (
            <div className="space-y-4 p-3 sm:p-4 bg-slate-900/50 rounded-xl border border-white/10">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 text-sm bg-slate-900/50 border border-white/10 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-white transition-colors"
                >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-3 bg-slate-800/50 rounded-lg border border-white/10">
                <div className="flex-1 min-w-0">
